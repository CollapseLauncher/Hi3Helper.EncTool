...
{
    internal static class SleepyExtension
    {
        ...
        internal static string ReturnUnescapedData(this ReadOnlySpan<byte> data)
        {
        ...
        internal static unsafe string StripTabsAndNewlinesUtf8(this ReadOnlySpan<char> s)
        {
